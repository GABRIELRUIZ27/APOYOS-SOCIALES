...
export class TiposIncidenciasComponent {
  ...
  iconosTabler = [
    ...
    { name: 'Desastres Naturales', class: 'ti ti-wind' },
    { name: 'Obstrucción de Vías', class: 'ti ti-barrier-block' },
    { name: 'Corte de Servicio Público', class: 'ti ti-server' },
    { name: 'Accidente Laboral', class: 'ti ti-alert-circle' },
    { name: 'Protestas o Manifestaciones', class: 'ti ti-flag' },
    { name: 'Problemas con el Suministro Eléctrico', class: 'ti ti-bolt' },
    { name: 'Daños en Infraestructura', class: 'ti ti-building-arch' }
  ];
